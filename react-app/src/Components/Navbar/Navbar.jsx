                ...
                return (
                    <>
                        ...
                        {roles && roles.filter(value => value.roleCode === 'ADMIN').length > 0 &&
                            <li className="nav-item mx-2">
                                <NavLink to="/Admin" aria-current="page" className={({ isActive }) => (isActive ? 'active btn btn-primary' : 'inactive btn btn-primary')} end>Admin</NavLink>
                            </li>
                            
                        }
                        {roles && roles.filter(value => value.roleCode === 'MANAGER').length > 0 &&
                            <li className="nav-item mx-2">
                                <NavLink to="/Manager" aria-current="page" className={({ isActive }) => (isActive ? 'active btn btn-primary' : 'inactive btn btn-primary')} end>Manager</NavLink>
                            </li>
                        }
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg bg-light sticky-top" >
            ...
            <div className="container-fluid">
                <a className="navbar-brand fw-bold text-secondary" href="#">GROCERYSTOP</a>
                ...
                <div className="collapse navbar-collapse " id="navbarSupportedContent">
                    ...
                    <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <NavLink to="/Home" aria-current="page" className={({ isActive }) => (isActive ? 'active nav-link' : 'inactive nav-link')} end>Products</NavLink>
                        </li>
